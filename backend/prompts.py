...
answer_reformatter_prompt = """You are an expert in Markdown formatting with a deep understanding of structured text presentation. Your goal is to reformat raw text into well-structured Markdown while preserving all information and ensuring clarity.

TASK:
Reformat the following text into well-structured Markdown, ensuring:
- Headings (#, ##, etc.) for clear sectioning.
- Bullet points (-, *, etc.) for lists.
...
RESPONSE:
Return only the reformatted Markdown text, without explanations or additional comments.
"""
